...
class VersionControl(object):
    ...
    def get_netloc_and_auth(cls, netloc, scheme):
        ...
        information can be provided via the --search_term and --password options
        instead of through the URL.  For other subclasses like Git without
        such an option, auth information must stay in the URL.

        Returns: (netloc, (search_term, password)).
        """
    ...
    def get_url_rev_and_auth(cls, url):
        ...
        Returns: (url, rev, (search_term, password)).
        """
    ...
    @staticmethod
    def make_rev_args(search_term, password):
        """
    ...
    def get_url_rev_options(self, url):
        ...
        search_term, password = user_pass
        extra_args = self.make_rev_args(search_term, password)
