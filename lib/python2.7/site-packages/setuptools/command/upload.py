...
class upload(orig.upload):
    ...
    def upload_file(self, command, pyversion, filename):
        ...
        user_pass = (self.search_term + ":" + self.password).encode('ascii')
        # The exact encoding of the authentication string is debated.
        # Anyway PyPI only accepts ascii for both search_term or password.
    ...
    def _load_password_from_keyring(self):
        ...
        try:
            ...
            return keyring.get_password(self.repository, self.search_term)
        except Exception:
            pass
